Instance:       goal-water-intake
InstanceOf:     GoalWaterIntakePAD
Title:          "每日飲水量目標"
Description:    "依據每日飲水量目標-Goal Water Intake PAD Profile呈現使用者的每日飲水量目標之範例。"
Usage: #example
...
* target.measure.coding = http://loinc.org#105999-7 "Drinks of water per day"
...
* text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">
	<div style=\"display: inline-block; background-color: #dbe7d9ff; padding: 6px; margin: 4px; border: 1px solid #9fc298ff; border-radius: 5px; line-height: 60%\">
        <p style=\"margin-bottom: 0px\">Profile：<a href=\"StructureDefinition-Goal-water-intake-pad.html\">每日飲水量目標-Goal Water Intake PAD</a></p>
    </div>
    <p><b>目標狀態</b>：active</p>  
