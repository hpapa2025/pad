Instance:       goal-fruits
InstanceOf:     GoalSixFoodGroupsFruitsPAD
Title:          "每日水果類食物攝取份數目標"
Description:    "依據每日水果類食物攝取份數目標-Goal Six Food Groups Fruits PAD Profile呈現每日水果類食物攝取目標之範例"
Usage: #example
* lifecycleStatus = #active
* category.coding = http://terminology.hl7.org/CodeSystem/goal-category#dietary
* description.coding = $SCT#787758000 "Estimated intake of fruit servings in 24 hours"
* subject.reference = "Patient/pat-min"

* startDate = "2025-08-30"

* target.measure = $LOINC#80458-3 "Fruit servings 24 hour Measured"

* target[0].detailQuantity.value = 4
...
* text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">
	<div style=\"display: inline-block; background-color: #dbe7d9ff; padding: 6px; margin: 4px; border: 1px solid #9fc298ff; border-radius: 5px; line-height: 60%\">
        <p style=\"margin-bottom: 0px\">Profile：<a href=\"StructureDefinition-Goal-six-food-groups-fruits-pad.html\">每日水果類食物攝取份數目標-Goal Six Food Groups Fruits PAD</a></p>
    </div>
    <p><b>目標狀態</b>：active</p>  
    <p><b>目標說明</b>：設定每日攝取的水果類食物份數</p>
