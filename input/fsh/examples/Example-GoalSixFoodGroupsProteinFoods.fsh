Instance:       goal-protein-foods
InstanceOf:     GoalSixFoodGroupsProteinFoodsPAD
Title:          "每日豆魚蛋肉類食物攝取份數目標"
Description:    "依據每日豆魚蛋肉類食物攝取份數目標-Goal Six Food Groups Protein Foods PAD Profile呈現每日豆魚蛋肉類食物攝取目標之範例"
Usage: #example
...
* target.measure = $LOINC#80464-1 "Protein servings 24 hour Measured"
...
* text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">
	<div style=\"display: inline-block; background-color: #dbe7d9ff; padding: 6px; margin: 4px; border: 1px solid #9fc298ff; border-radius: 5px; line-height: 60%\">
        <p style=\"margin-bottom: 0px\">Profile：<a href=\"StructureDefinition-Goal-six-food-groups-proteinFoods-pad.html\">每日豆魚蛋肉類食物攝取份數目標-Goal Six Food Groups Protein Foods PAD</a></p>
    </div>
    <p><b>目標狀態</b>：active</p>  
