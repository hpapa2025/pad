Instance:       goal-six-food-groups-oilsAndNuts
InstanceOf:     GoalSixFoodGroupsPAD
Title:          "每日油脂與堅果種子類食物攝取份數目標"
Description:    "依據每日油脂與堅果種子類食物攝取份數目標-Goal Six Food Groups PAD Profile呈現使用者的每日油脂與堅果種子類食物攝取目標之範例。"
Usage: #example
...
* target.measure.coding = $LOINC#80466-6 "Oil servings 24 hour Measured"
