Instance:       goal-grains
InstanceOf:     GoalSixFoodGroupsGrainsPAD
Title:          "每日全穀雜糧類食物攝取份數目標"
Description:    "依據每日全穀雜糧類食物攝取份數目標-Goal Six Food Groups Grains PAD Profile呈現每日全穀雜糧類食物攝取目標之範例"
Usage: #example
* lifecycleStatus = #active
* category.coding = http://terminology.hl7.org/CodeSystem/goal-category#dietary
* description.coding = $SCT#789332008 "Estimated intake of grain servings in 24 hours"
* subject.reference = "Patient/pat-min"

* startDate = "2025-08-30"

* target.measure = $LOINC#80456-7 "Grain servings 24 hour Measured"

* target[0].detailQuantity.value = 3
...
* text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">
	<div style=\"display: inline-block; background-color: #dbe7d9ff; padding: 6px; margin: 4px; border: 1px solid #9fc298ff; border-radius: 5px; line-height: 60%\">
        <p style=\"margin-bottom: 0px\">Profile：<a href=\"StructureDefinition-Goal-six-food-groups-grains-pad.html\">每日全穀雜糧類食物攝取份數目標-Goal Six Food Groups Grains PAD</a></p>
    </div>
    <p><b>目標狀態</b>：active</p>  
    <p><b>目標說明</b>：設定每日攝取的全穀雜糧類食物</p>
    <p><b>使用者</b>：<a href=\"Patient-pat-min.html\">Patient/pat-min</a></p>
    <p><b>目標紀錄日期</b>：2025-08-30</p>
    <p><b>全穀雜糧類目標</b>：3 份/天</p>
    <p><b>目標期限</b>：1 天內</p>
</div>"