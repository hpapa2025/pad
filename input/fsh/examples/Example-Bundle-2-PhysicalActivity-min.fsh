...
* entry[observation-steps].fullUrl = "https://www.hpa.gov.tw/pad/Observation/obs-day-steps"
...
* entry[observation-floors].fullUrl = "https://www.hpa.gov.tw/pad/Observation/obs-day-floors"
...
* entry[observation-distance].fullUrl = "https://www.hpa.gov.tw/pad/Observation/obs-day-distance"
...
* entry[observation-heart-rate].fullUrl = "https://www.hpa.gov.tw/pad/Observation/obs-heart-rate"
...
* entry[observation-sleep-hours].fullUrl = "https://www.hpa.gov.tw/pad/Observation/obs-sleep-hours"
...
* entry[observation-stress].fullUrl = "https://www.hpa.gov.tw/pad/Observation/obs-stress-index"
...
* entry[observation-stand].fullUrl = "https://www.hpa.gov.tw/pad/Observation/obs-stand-hours"
...
* entry[observation-exercise].fullUrl = "https://www.hpa.gov.tw/pad/Observation/obs-exercise"
