Instance:       goal-six-food-groups-vegetables
InstanceOf:     GoalSixFoodGroupsPAD
Title:          "每日蔬菜類食物攝取份數目標"
Description:    "依據每日蔬菜類食物攝取份數目標-Goal Six Food Groups PAD Profile呈現使用者的每日蔬菜類食物攝取目標之範例。"
Usage: #example
...
* target.measure.coding = $LOINC#80460-9 "Vegetable servings 24 hour Measured"
