...
Title:          "靜態/久坐時間"
Description:    "依據靜態/久坐時間-Observation Sedentary Time PAD Profile呈現使用者靜態/久坐時間之範例"
Usage: #example
* status = #final
...
* text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">
	<div style=\"display: inline-block; background-color: #dbe7d9ff; padding: 6px; margin: 4px; border: 1px solid #9fc298ff; border-radius: 5px; line-height: 60%\">
        <p style=\"margin-bottom: 0px\">Profile：<a href=\"StructureDefinition-Observation-sedentary-time-pad.html\">靜態/久坐時間-Observation Sedentary Time PAD</a></p>
    </div>
    <p><b>狀態</b>：final</p>  
