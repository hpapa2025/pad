Instance:       goal-vegetables
InstanceOf:     GoalSixFoodGroupsVegetablesPAD
Title:          "每日蔬菜類食物攝取份數目標"
Description:    "依據每日蔬菜類食物攝取份數目標-Goal Six Food Groups Vegetables PAD Profile呈現每日蔬菜類食物攝取目標之範例"
Usage: #example
* lifecycleStatus = #active
* category.coding = http://terminology.hl7.org/CodeSystem/goal-category#dietary
* description.coding = $SCT#789334009 "Estimated intake of vegetable servings in 24 hours"
* subject.reference = "Patient/pat-min"

* startDate = "2025-08-30"

* target.measure = $LOINC#80460-9 "Vegetable servings 24 hour Measured"
...
* text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">
	<div style=\"display: inline-block; background-color: #dbe7d9ff; padding: 6px; margin: 4px; border: 1px solid #9fc298ff; border-radius: 5px; line-height: 60%\">
        <p style=\"margin-bottom: 0px\">Profile：<a href=\"StructureDefinition-Goal-six-food-groups-vegetables-pad.html\">每日蔬菜類食物攝取份數目標-Goal Six Food Groups Vegetables PAD</a></p>
    </div>
    <p><b>目標狀態</b>：active</p>  
    <p><b>目標說明</b>：設定每日攝取的蔬菜類食物</p>
