Instance:       goal-six-food-groups-dairy
InstanceOf:     GoalSixFoodGroupsPAD
Title:          "每日乳品類食物攝取份數目標"
Description:    "依據每日乳品類食物攝取份數目標-Goal Six Food Groups PAD Profile呈現使用者的每日乳品類食物攝取目標之範例。"
Usage: #example
...
* target.measure.coding = $LOINC#80462-5 "Dairy servings 24 hour Measured"
