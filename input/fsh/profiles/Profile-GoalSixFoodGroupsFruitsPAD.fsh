Profile:        GoalSixFoodGroupsFruitsPAD
Parent:         TWCoreGoal
Id:             Goal-six-food-groups-fruits-pad
Title:          "每日水果類食物飲食目標-Goal Six Food Groups Fruits PAD"
Description:    "此每日水果類食物飲食目標-Goal Six Food Groups Fruits PAD Profile說明PAD IG如何進一步定義臺灣核心-目標（TW Core Goa）Profile以呈現每日六大類食物中的水果類攝取份數目標。"
* lifecycleStatus = #active
* category 1..1
* category = http://terminology.hl7.org/CodeSystem/goal-category#dietary
* description ^short = "設定水果類食物攝取份數目標"
* description.coding 1..1
* description.coding = $SCT#787758000
...
* target.measure 1..1
* target.measure ^short = "水果類食物"
* target.measure = $LOINC#80458-3

* target.detail[x] 1..1
* target.detail[x] only Quantity
* target.detailQuantity ^short = "水果類食物攝取目標"
