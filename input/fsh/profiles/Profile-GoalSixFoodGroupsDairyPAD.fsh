Profile:        GoalSixFoodGroupsDairyPAD
Parent:         TWCoreGoal
Id:             Goal-six-food-groups-dairy-pad
Title:          "每日乳品類食物攝取份數目標-Goal Six Food Groups Dairy PAD"
Description:    "此每日乳品類食物攝取份數目標-Goal Six Food Groups Dairy PAD Profile說明PAD IG如何進一步定義臺灣核心-目標（TW Core Goa）Profile以呈現每日六大類食物中的乳品類攝取份數目標。"
* lifecycleStatus = #active
* category 1..1
* category = http://terminology.hl7.org/CodeSystem/goal-category#dietary
* description ^short = "設定乳品類食物攝取份數目標"
* description.coding 1..1
* description.coding = $SCT#789392006
...
* target.measure 1..1
* target.measure ^short = "乳品類食物"
* target.measure = $LOINC#80462-5

* target.detail[x] 1..1
* target.detail[x] only Quantity
* target.detailQuantity ^short = "乳品類食物攝取目標"
