...
* entry[goal-weight].request.method ^short = "POST | PUT"
...
* entry[goal-weight-change].request.method ^short = "POST | PUT"
...
* entry[goal-loss-intensity].request.method ^short = "POST | PUT"
...
* entry[goal-day-calories-burned].request.method ^short = "POST | PUT"
...
* entry[goal-day-steps].request.method ^short = "POST | PUT"
...
* entry[goal-day-floors].request.method ^short = "POST | PUT"
...
* entry[goal-day-distance].request.method ^short = "POST | PUT"
...
* entry[goal-week-calories-burned].request.method ^short = "POST | PUT"
...
* entry[goal-week-exercise-amount].request.method ^short = "POST | PUT"
...
* entry[goal-water-intake].request.method ^short = "POST | PUT"
...
* entry[goal-calories-intake].request.method ^short = "POST | PUT"
...
* entry[goal-dairy].request.method ^short = "POST | PUT"
...
* entry[goal-fruits].request.method ^short = "POST | PUT"
...
* entry[goal-grains].request.method ^short = "POST | PUT"
...
* entry[goal-oils-and-nuts].request.method ^short = "POST | PUT"
...
* entry[goal-protein-foods].request.method ^short = "POST | PUT"
...
* entry[goal-vegetables].request.method ^short = "POST | PUT"