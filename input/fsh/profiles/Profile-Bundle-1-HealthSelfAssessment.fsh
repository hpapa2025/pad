...
* entry contains
	...
	condition-cancer 0..* MS and
	condition-cvd 0..* MS and
	condition-dm 0..* MS and
	condition-hbp 0..* MS and
	condition-hld 0..* MS and
	condition-cd 0..* MS and
...
* entry[goal-health].request.method ^short = "POST | PUT"
...
* entry[observation-eating-out].request.method ^short = "POST | PUT"
...
* entry[observation-dietary].request.method ^short = "POST | PUT"
...
* entry[observation-occupation].request.method ^short = "POST | PUT"
...
* entry[observation-sedentary].request.method ^short = "POST | PUT"
...
* entry[observation-exercise-frequency].request.method ^short = "POST | PUT"
...
* entry[observation-exercise-amount].request.method ^short = "POST | PUT"
...
* entry[observation-smoking].request.method ^short = "POST | PUT"
...
* entry[condition-cancer].request.method ^short = "POST | PUT"
...
* entry[condition-cvd].request.method ^short = "POST | PUT"
...
* entry[condition-dm].request.method ^short = "POST | PUT"
...
* entry[condition-hbp].request.method ^short = "POST | PUT"
...
* entry[condition-hld].request.method ^short = "POST | PUT"
...
* entry[condition-cd].request.method ^short = "POST | PUT"
...
* entry[familyMemberHistory].request.method ^short = "POST | PUT"