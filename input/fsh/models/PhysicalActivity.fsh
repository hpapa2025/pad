...
Title: "情境2-運動紀錄之資料模型"
Description: """
本邏輯模型用於描述使用者之運動紀錄的資料結構，協助國民健康署推動以資料驅動的健康促進服務。為利實作者理解與應用，資料欄位採通俗命名，實作時可參考「Mappings」功能頁籤，對應至實際所使用之Profiles與資料項目。亦可參照[視覺化邏輯模型圖](vision-3.html)進行欄位對照與整體結構掌握。
"""
* ^version = "0.1.0"

// 身體活動紀錄
* physActRecord 1..1 BackboneElement "身體活動紀錄"
* physActRecord.dailySteps 1..1 integer "每日步數"
* physActRecord.dailyFloors 1..1 integer "每日爬升樓層"
* physActRecord.dailyDistance 1..1 integer "每日運動距離"
* physActRecord.standHours 1..1 integer "站立時數"

// 生理檢測
* physiologicalMetrics 1..1 BackboneElement "生理檢測"
* physiologicalMetrics.heartRate 1..1 integer "心率"
* physiologicalMetrics.sleepHours 1..1 integer "睡眠時數"
* physiologicalMetrics.stressIndex 1..1 integer "壓力指數"
