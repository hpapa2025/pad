...
* bodyMetrics.bri -> "entry:ObservationBRIPAD.where(code.coding.code = 'bri' and code.coding.system='https://fhir.hpa.gov.tw/pad/CodeSystem/pad-metrics').valueQuantity.value"
...
* bodyMetrics.bmr -> "entry:ObservationBMRPAD.where(code.coding.code = 'bmr' and code.coding.system='https://fhir.hpa.gov.tw/pad/CodeSystem/pad-metrics').valueQuantity.value"
