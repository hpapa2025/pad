...
* rest.resource[=].supportedProfile[0] = "https://fhir.hpa.gov.tw/pad/StructureDefinition/Bundle-physical-activity-pad"
* rest.resource[=].supportedProfile[+] = "https://fhir.hpa.gov.tw/pad/StructureDefinition/Bundle-diet-record-pad"
* rest.resource[=].supportedProfile[+] = "https://fhir.hpa.gov.tw/pad/StructureDefinition/Bundle-health-risk-assessment-pad"
...
* rest.resource[=].searchParam[=].definition = "https://fhir.hpa.gov.tw/pad/SearchParameter/Patient-name"
* rest.resource[=].searchParam[=].type = #string
* rest.resource[=].searchParam[=].extension.url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
* rest.resource[=].searchParam[=].extension.valueCode = #SHALL
* rest.resource[=].searchParam[+].name = "identifier"
* rest.resource[=].searchParam[=].definition = "https://fhir.hpa.gov.tw/pad/SearchParameter/Patient-identifier"
...
* rest.resource[=].supportedProfile[0] = "https://fhir.hpa.gov.tw/pad/StructureDefinition/Observation-daily-steps-pad"
...
* rest.resource[=].supportedProfile[0] = "https://fhir.hpa.gov.tw/pad/StructureDefinition/Condition-dm-pad"
* rest.resource[=].supportedProfile[+] = "https://fhir.hpa.gov.tw/pad/StructureDefinition/Condition-hbp-pad"
* rest.resource[=].interaction[0].extension.url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
* rest.resource[=].interaction[=].extension.valueCode = #SHALL
* rest.resource[=].interaction[=].code = #create
* rest.resource[=].interaction[+].extension.url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
